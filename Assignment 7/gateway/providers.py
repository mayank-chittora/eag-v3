...
def build_providers(cache_store):
    ...
    if k := os.getenv("GEMINI_API_KEY"):
        for _name, _model in [
            ...
            ("gemini-lite",    os.getenv("GEMINI_MODEL_LITE", "gemini-2.5-flash-lite")),
            ("gemini-35",      os.getenv("GEMINI_MODEL_35",   "gemini-3.5-flash")),
            ("gemini-31-lite", os.getenv("GEMINI_MODEL_31L",  "gemini-3.1-flash-lite")),
        ]:
            out[_name] = GeminiProvider(k, _model, cache_store)
