...
class Skill:
    def __init__(self, name: str, cfg: dict):
        ...
        # Per-skill temperature / max_tokens come from the yaml so tuning a
        # single skill no longer requires a code edit. Defaults are
        # deliberately conservative; a skill that wants exploration
